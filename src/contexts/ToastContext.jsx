        ...
        <div className="flex border-l border-gray-200">
          <button
            ...
            className="w-full border border-transparent rounded-none rounded-r-lg p-4 
              flex items-center justify-center text-sm font-medium text-primary-600 
              hover:text-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
            Close
          </button>
        </div>
            ...
            <div className="ml-3 flex-1">
              ...
              {details && process.env.NODE_ENV === 'development' && (
                <details className="mt-2">
                  ...
                  <pre className="mt-1 text-xs text-gray-400 overflow-auto max-h-20">
