    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">View and manage your past career analyses</p>
        </div>
        ...
        {analyses.length > 0 ? (
          <>
            ...
            {filteredAnalyses.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-gray-600">No analyses found matching your search.</p>
              </div>
            ) : (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-6">Start by selecting a career to analyze your qualifications.</p>
            <button
