...
function DimensionRadarChart({ data, selectedDimension, onDimensionSelect, onDimensionHover, hoveredDimension: externalHoveredDimension, isAutoCycling, showProgress, cycleProgress }) {
